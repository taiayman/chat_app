                ...
                >
                    ...
                    <div className="w-full max-w-[380px] bg-transparent border-2 border-zinc-200 rounded-[28px] px-5 py-7">
                        <div className="space-y-4">
                            ...
                            <Button
                                variant="outline"
                                className="w-full h-10 bg-white border-2 border-zinc-200 text-zinc-700 hover:bg-zinc-50 hover:border-zinc-300 justify-center gap-3 rounded-xl text-sm font-medium shadow-none"
                            >
                                <GoogleIcon />
